...
from core.RED.ssd.layers import SeparableConv2d
...
class BoxPredictor(nn.Module):
    def __init__(self, cfg):
        ...
        for level, (boxes_per_location, out_channels) in enumerate(zip(cfg.MODEL.PRIORS.BOXES_PER_LOCATION, cfg.MODEL.OUT_CHANNELS)):
