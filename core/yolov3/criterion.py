...
class Criterion(nn.Module):
    ...
    def forward(self, pred_obj, pred_cls, pred_iou, targets):
        ...
        #     print("pred_obj",torch.isnan(pred_obj).sum())
        #     print("target_obj",torch.isnan(target_obj).sum())
        #     print("pred_cls",torch.isnan(pred_cls).sum())
        #     print("target_cls",torch.isnan(target_cls).sum())
        #     print("pred_iou",torch.isnan(pred_iou).sum())
        #     print("loss_reg",torch.isnan(target_cls).sum())
